import{i as a,b as o,a as n}from"./lit-element.D8DSg5zn.js";import{t as s}from"./typography.KBHeYOQc.js";import{b as l}from"./boolish.DOQu-9JQ.js";class d extends a{static{this.properties={files:{type:Array},removable:{type:Boolean,reflect:!0},downloadable:{type:Boolean,reflect:!0,converter:l}}}constructor(){super(),this.files=[],this.removable=!1,this.downloadable=!0}emit(e,t,i){this.dispatchEvent(new CustomEvent(e,{detail:{file:t,index:i},bubbles:!0,composed:!0}))}onRemove(e){const t=this.files[e];this.files=this.files.filter((i,r)=>r!==e),this.emit("remove",t,e)}render(){return this.files.length?o`
      <ul class="list">
  ...
  `]}}customElements.get("esa-file-list")||customElements.define("esa-file-list",d);
